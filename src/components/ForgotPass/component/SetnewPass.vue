        ...
        <div class="ForgotPasswordCardSize">
            ...
            <Form ref="formCustom" :model="formCustom"
                ...
                <FormItem prop="newPassword">
                    <Input type="password" v-model="formCustom.newPassword" class="ForgotPasswordInput"
                ...
                <FormItem>
                    ...
                    <!--<div :class="!formCustom.password || !formCustom.newPassword ? 'ForgotPasswordContentButton' : 'ForgotPasswordContentButtonis'" @click="handleSubmit('formCustom')">-->
                        <!--Confirm-->
                    <!--</div>-->
                </FormItem>
            </Form>
        ...
        methods: {
            ...
            async LoadData (record) {
                try {
                    ...
                    let data = await api.resetForcePassword(list)
                    console.log(data);
